...
const query = client.query(
 ...
 //'CREATE TABLE peptides(id SERIAL PRIMARY KEY, swiss_prot_id VARCHAR(40), gene_name VARCHAR(40), peptide VARCHAR(100), modified_peptide VARCHAR(100))');
 "COPY peptides(swiss_prot_id, gene_name, peptide, modified_peptide) FROM 'C:/Users/HuangL3/Documents/decision_tree_peptides.csv' WITH(DELIMITER ',', FORMAT CSV, HEADER);");
